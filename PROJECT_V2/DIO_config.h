...
//PORTA
#define DIO_PIN_NUM_A0_DIR		DIO_INPUT
...
//PORTB
#define DIO_PIN_NUM_B0_DIR		DIO_INPUT
#define DIO_PIN_NUM_B1_DIR		DIO_INPUT
#define DIO_PIN_NUM_B2_DIR		DIO_INPUT
#define DIO_PIN_NUM_B3_DIR		DIO_INPUT
...
//PORTD
#define DIO_PIN_NUM_D0_DIR		DIO_OUTPUT
#define DIO_PIN_NUM_D1_DIR		DIO_OUTPUT
#define DIO_PIN_NUM_D2_DIR		DIO_OUTPUT
#define DIO_PIN_NUM_D3_DIR		DIO_OUTPUT
